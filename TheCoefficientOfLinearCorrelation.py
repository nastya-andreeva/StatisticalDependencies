...
# Выводим результаты
print(f"Среднее значение данных: {mean_un_val}")
print(f"Среднее значение частот: {mean_freq}")
print(f"Отклонения от среднего для данных: {deviations_un_val}")
print(f"Отклонения от среднего для частот: {deviations_freq}")
print(f"Сумма произведений отклонений: {sum_of_products}")
print(f"Сумма квадратов отклонений для данных: {sum_of_squares_un_val}")
print(f"Сумма квадратов отклонений для частот: {sum_of_squares_freq}")
print(f"Коэффициент корреляции Пирсона: {pearson_correlation}")

"заметная,отрицательное – обратная"